...
class OneAndOneNodeDriver(NodeDriver):
    ...
    def create_node(self, name, ex_image, ex_fixed_instance_size_id,
                    password=None, ex_ip=None, ex_ssh_key=None,
                    ex_datacenter_id=None, ex_monitoring_policy_id=None,
                    ex_firewall_policy_id=None, ex_loadbalancer_id=None,
                    ex_description=None, ex_power_on=None):
        """
        Creates a node.
        ...
        :param ex_image: Image ID from list_images
        :rtype: ``str``
        ...
        :param ex_datacenter_id: Data center ID
        :type ```str```
        ...
        body = {
            "name": name,
            "appliance_id": ex_image,
            "hardware": {
                "fixed_instance_size_id": ex_fixed_instance_size_id
            },
        }

        if ex_datacenter_id is not None:
            body['datacenter_id'] = ex_datacenter_id
